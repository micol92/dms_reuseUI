					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Reuse UI5 Title",
									"targetURL": "#dmsreuseui5-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"dmsreuseui5-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=dmsreuseui5",
									"url": sap.ui.require.toUrl("dmsreuseui5")
								}
							}
						}
					}
